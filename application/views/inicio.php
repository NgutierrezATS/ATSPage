    ...
    <div class="container">
            <div class="text-center"><h2>Máquinas Destacadas</h2></div>
            <br><br><br>
        <div class="row">
            <div class="col-md-12">
                <div class="col-md-4">
                    <div class="thumbnail">
                        <img src="<?php echo base_url()."assets/"; ?>slider/img/noticia 1.jpg" alt="">
                        <div class="caption">
                            <h4>Llegue más alto con una mayor variedad en Elevadores JLG</h4>
                            <p>Los elevadores de tijera de JLG electricos que están disponibles en las alturas desde 8,1 metros a 14,19 metros. Sea más productivo con estas opciones confiables y de fácil servicio.</p>
                            <!-- <button class="btn btn-ats center-block">Mas información</button> -->
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="thumbnail">
                        <img src="<?php echo base_url()."assets/"; ?>slider/img/noticia 2.jpg" alt="">
                        <div class="caption">
                            <h4>GENIE Z-60/37FE Galardonada por ERA como producto de alquiler de 2017</h4>
                            <p>Esta máquina lleva la tecnología híbrida a un nivel completamente nuevo, y el reconocimiento de ERA reafirma que el legado de Genie</p>
                            <!-- <button class="btn btn-ats center-block">Mas información</button> -->
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="thumbnail">
                        <img src="<?php echo base_url()."assets/"; ?>slider/img/noticia 3.jpg" alt="">
                        <div class="caption">
                            <h4>Un manipulador telescópico de JLG tiene la potencia, el alcance y la versatilidad para hacer el trabajo. </h4>
                            <p>Nuestros manipuladores telescópicos cuentan con dirección en todas las ruedas, incluyendo círculo de dos ruedas, de cuatro ruedas y cangrejo de cuatro ruedas para cumplir varios requisitos de maniobrabilidad</p>
                            <!-- <button class="btn btn-ats center-block">Mas información</button> -->
                        </div>
                    </div>
                </div>
